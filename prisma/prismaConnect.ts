import { PrismaClient as PrismaClient_game } from "./libs/game";
...
declare global {
var prisma_game: PrismaClient_game | undefined;
var prisma_nextauth: PrismaClient_nextauth | undefined;
var prisma_phpmyadmin: PrismaClient_phpmyadmin | undefined;
}
export const prismaConnect_game = global.prisma_saf ||= new PrismaClient_game();
